  ...
  return (
    ...
    >
      <Box display="flex" alignItems={"center"} flex="0.3">
        <Image h="210px" src={"https://github.com/dark-shad/etamax_imagaes/blob/main/WhatsApp%20Image%202022-09-09%20at%202.38.33%20PM.jpeg?raw=true"} />
      </Box>
      <Flex flex="0.7" flexDir="column" gridGap={2} color={'white'}>
